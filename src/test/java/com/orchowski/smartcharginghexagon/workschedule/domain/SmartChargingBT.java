...
import com.orchowski.smartcharginghexagon.workschedule.adapters.ContextCreator;
...
class SmartChargingBT {
    ...
    private final Integer LOW_PRIORITY = 1000;
    private final Integer MEDIUM_PRIORITY = 2000;

    private final Integer HIGH_PRIORITY = 3000;
    ...
    void shouldCreateValidWorkScheduleFromSinglePolicy() {
         ...
         *
         *  */
        WorkScheduleService workScheduleService = ContextCreator.getWorkScheduleService();
